    ...
    <footer>
      <div className="footer-content">
        <div className="social-links">
          ...
          <a href="https://www.instagram.com/emoti_onproduction?igsh=MW5sZ2QxZGlpa3gyOA%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram">📷</a>
        </div>
